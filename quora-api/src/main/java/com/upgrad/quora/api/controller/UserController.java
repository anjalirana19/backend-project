      ...
      @Autowired
        ...
        public ResponseEntity<SignupUserResponse> signup(final SignupUserRequest signupUserRequest) throws SignUpRestrictedException
        {
            UserEntity entity = null;
              if(userBusinessService.checkUserName(signupUserRequest.getUserName()) && userBusinessService.checkEmail(signupUserRequest.getEmailAddress()) ) {
                 ...
                 entity=userBusinessService.signup(userEntity);
              }
